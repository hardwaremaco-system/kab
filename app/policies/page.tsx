...
export const metadata = {
  title: "Policies & Terms | Mbarara Online",
  description: "Buyer protection, refund policies, and seller terms for Mbarara Online.",
};
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="bg-slate-900 px-8 py-10 text-center">
          ...
          <p className="text-slate-300 text-sm max-w-xl mx-auto">
            Everything you need to know about buying safely, selling profitably, and how Mbarara Online protects our community.
          </p>
        </div>
        ...
        <div className="p-8 sm:p-10 space-y-10 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-4">
              We want you to shop with absolute confidence. Mbarara Online acts as a secure bridge between you and local sellers across Mbarara City.
            </p>
            <ul className="space-y-3 list-none pl-0">
              ...
              <li className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  For Cash on Delivery (COD) orders, you have the right to inspect both used and new items upon delivery. If it does not match the description, is defective, or is counterfeit, you may reject it on the spot at no cost.
                </div>
              </li>
              <li className="flex gap-3 items-start">
                <span className="text-red-500 font-bold mt-0.5">💳</span>
          ...
          <section>
            ...
            <p className="mb-4">
              Mbarara Online provides the marketing, local discovery tools, and secure payment infrastructure to help you grow your business in Mbarara.
            </p>
            <ul className="space-y-3 list-none pl-0">
              <li className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  Posting your items on Mbarara Online is 100% free. You only pay when you make a successful sale.
                </div>
              </li>
              <li className="flex gap-3 items-start">
                <span className="text-green-600 font-bold mt-0.5">✓</span>
              ...
              <li className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  For COD orders, sellers collect 100% of the cash directly from the buyer. Mbarara Online reserves the right to review high-volume COD sellers and may introduce subscription tiers in the future.
                </div>
              </li>
              <li className="flex gap-3 items-start">
                <span className="text-green-600 font-bold mt-0.5">✓</span>
          ...
          <section>
            ...
            <p className="mb-3">To keep our community safe, the following items are strictly forbidden on Mbarara Online:</p>
            <ul className="list-disc pl-5 space-y-1 text-sm text-slate-600">
              ...
              <li>Live animals (unless explicitly approved in authorized categories).</li>
            </ul>
        ...
        <div className="bg-slate-50 border-t border-slate-200 p-8 text-center">
          ...
          <Link 
            href="https://wa.me/256779094664?text=Hi!%20I%20have%20a%20question%20about%20Mbarara%20Online%20policies." 
            target="_blank" 
