...
export default function SettingsPage() {
  ...
  const currentDisplayName = user.referralName || user.displayName?.split(' ')[0] || "Mbarara Online User";
      ...
      <div className="max-w-[480px] md:max-w-2xl mx-auto p-4 pt-6">
        ...
        <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 w-full">
          ...
          <ul className="text-[12px] text-slate-600 font-medium space-y-2 pl-4 list-disc marker:text-[#D97706]">
            <li><strong className="text-slate-800 font-black">Official Items Only:</strong> Commissions apply only to verified official Mbarara Online stock. Third-party seller items are excluded.</li>
